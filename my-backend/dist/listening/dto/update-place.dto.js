...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: String, description: 'Vietnamese place name', example: 'Siêu thị' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdatePlaceDto.prototype, "nameVi", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ type: String, description: 'Japanese place name', example: 'スーパー' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], UpdatePlaceDto.prototype, "nameJa", void 0);
__decorate([
